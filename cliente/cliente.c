// Este es un ejemplo robado y no es el cliente final que planeo utilizar, pero sirve para probar la comunicación entre el cliente y el servidor.
// No recuerdo de donde me lo robe y la idea era que no se viera en los commits pero se me olvido sacarlo de la carpeta y se filtró -_-
...
// Esto es algo que guarde por si acaso jeje
/*
